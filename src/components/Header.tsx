      ...
      >
        <div className="container-lux flex items-center justify-between px-7 lg:px-20">
          <Link
            ...
            className="flex items-center justify-start gap-3 py-1 pr-2 sm:pr-4"
          >
            <img
              src="/v5logo.png"
              ...
              className="h-[42px] w-auto max-w-[170px] shrink-0 object-contain sm:h-[48px] lg:h-[52px]"
            />
            <span
              className={`hidden whitespace-nowrap text-[13px] font-medium leading-[1.1] tracking-[0.08em] text-forest/80 sm:inline sm:text-[14px] lg:text-[15px] ${transparent ? "text-ivory/90" : "text-forest/80"}`}
